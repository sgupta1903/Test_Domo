 ...
 */
public class ClipboardPage extends AbcCommonAbstractPage<ClipboardPage> {
    ...
    public static String get_text() {
        Transferable clipboardContents = getSystemClipboard().getContents(ClipboardPage.class);
     ...
     */
    public static void put_text(CharSequence data) {
     ...
     */
    public static void put_text(TextType type, Charset charset, TransferType transferType, CharSequence data) {
