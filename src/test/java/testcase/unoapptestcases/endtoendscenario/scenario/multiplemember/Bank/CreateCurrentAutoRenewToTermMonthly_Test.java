...
@Issue("A30TP-11777")
@Slf4j
public class CreateCurrentAutoRenewToTermMonthly_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK);
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-9647");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,
                        SUB_DOWNPAYMENT))
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,
    ...
    public void enterAutoRenewToTermDetails() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                ...
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
  ...
  getPage( UnoAppMemberDetailPage.class )
    ...
    public void verifyNotesTab() {
        ...
        getPage(UnoAppNotesTabPage.class)
                .select_notes_tab()
                .verify_primary_member_notes(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_AUTORENEWTOTERM_MONTHLY_BANK,MEMBER_NOTES));
    }
