...
import static helper.DataProviderSection.CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-11999")
@Slf4j
public class CreateCurrentOpenEndedQuarterly_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD);
    }
    ...
    @Test
    @Description("Enter details for subscription creation")
    @TmsLink("A30TP-19339")
    public void enterDetailsForSubscription() {
        log.info("Entering the details of subscription");
        setTestResultOnXRay("A30TP-19339");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create 'Open-End' Subscription with Payment Method Type as 'Credit Card' with begin date is current and frequency is quarterly with two members.")
    @TmsLink("A30TP-19343")
    public void enterOpenEndedSubscriptionDetails() {
        log.info("Create 'Open-End' Subscription with Payment Method Type as 'Credit Card' with begin date is current and frequency is quarterly with two members.");
        setTestResultOnXRay("A30TP-19343");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-19348");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,SUB_CARD_HOLDER_NAME));
    }
    ...
    public void verifyNotesTab() {
        ...
        getPage(UnoAppNotesTabPage.class)
                .select_notes_tab()
                .verify_primary_member_notes(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_QUARTERLY_CARD,MEMBER_NOTES));
    }
