...
@Issue("A30TP-12003")
@Slf4j
public class CreateCurrentOpenEndedMonthlyWithDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_MEMBER_OPENENDED_MONTHLY_WTH_DWN_PAY_BANK);
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-12202");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_OPENENDED_MONTHLY_WTH_DWN_PAY_BANK,
                        SUB_DOWNPAYMENT));
    ...
    public void enterScehduleDetails() {
        ...
        setTestResultOnXRay("A30TP-18031");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_OPENENDED_MONTHLY_WTH_DWN_PAY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_OPENENDED_MONTHLY_WTH_DWN_PAY_BANK,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-18028");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_MONTHLY_WTH_DWN_PAY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_MONTHLY_WTH_DWN_PAY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_OPENENDED_MONTHLY_WTH_DWN_PAY_BANK,SUB_TYPE));
    }
  ...
  getPage( UnoAppMemberDetailPage.class )
    ...
    public void verifyNotesTab() {
        ...
        getPage(UnoAppNotesTabPage.class)
                .select_notes_tab()
                .verify_primary_member_notes(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_BIWEEKLY_BANK,MEMBER_NOTES));
    }
