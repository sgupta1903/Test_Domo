...
import static helper.DataProviderSection.MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD;
...
public class CreatePastMultipleSubsMonthlyWithOutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD);
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void createOpenEndedSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,
    ...
    public void createSecondSubscription() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .enter_open_ended_another_subscription_details(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_CARD,SUB_CARD_HOLDER_NAME));
    }
