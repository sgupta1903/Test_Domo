...
import static helper.DataProviderSection.PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK;
...
public class CreatePastMultipleSubsAnnuallyWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK);
    }
    ...
    @Test
    @Description("Create multiple subscription one is open-ended subscription and other is installment auto renew to open subscription with annually frequency where begin and due date is past with bank account")
    @TmsLink("A30TP-38717")
    public void createNonRenewSubscription() {
        log.info("Create multiple subscription one is open-ended subscription and other is installment auto renew to open subscription with annually frequency where begin and due date is past with bank account");
        setTestResultOnXRay("A30TP-38717");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK,
                        SUB_DOWNPAYMENT))
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK,
    ...
    public void verifySubscriptionCreated() {
        log.info("Create multiple subscription one is open-ended subscription and other is installment auto renew to open subscription with annually frequency where begin and due date is past with bank account");
        setTestResultOnXRay("A30TP-38720");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        setTestResultOnXRay("A30TP-38724");
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK, SUB_TYPE));
    }
    ...
    public void createAnotherSubs() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .enter_installment_another_subscription_details(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK,
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_ANNUALLY_DUE_DATE_PAST_BANK, SUB_CARD_HOLDER_NAME));
