...
import static helper.DataProviderSection.MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK;
...
public class CreateFutureMultipleSubsSemiAnnuallyWitoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(DataProviderSection.MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create multiple Open ended subscription for one member with Semi-Annually frequency where begin date is Future with bank account")
    public void createOpenEndedSubscription() {
        logger.info("Create multiple Open ended subscription for one member with Semi-Annually frequency where begin date is Future with bank account");
        setTestResultOnXRay("A30TP-16377");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,
    ...
    public void verifySubscriptionCreated() {
        logger.info("Create multiple Open ended subscription for one member with Semi-Annually frequency where begin date is Future with bank account");
        setTestResultOnXRay("A30TP-16380");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,SUB_TYPE));
    }

    @Test
    @Description("Creating another subscription")
    public void createAnotherSubscription() {
        logger.info("Creating another subscription with same member");
        setTestResultOnXRay("A30TP-15763");
        getPage(UnoAppMemberDetailPage.class)
                .enter_open_ended_another_subscription_details(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_wallet_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,MULTIPLE_SUBS_FUTURE_WITHOUT_DWNPAY_OPEMENDED_SEMIANNUALLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
