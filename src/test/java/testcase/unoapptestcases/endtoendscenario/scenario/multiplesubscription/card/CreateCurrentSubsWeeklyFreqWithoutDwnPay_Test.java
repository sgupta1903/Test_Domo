...
@Issue("A30TP-13136")
@Slf4j
public class CreateCurrentSubsWeeklyFreqWithoutDwnPay_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD);
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create multiple subscription when subscription type is installment Subscription with non-renew agreement type when begin date and expiration date is past and frequency is Weekly with Credit Card with amount $40 .")
    @TmsLink("A30TP-38686")
    public void createNonRenewInstallmentSubscription() {
        log.info("Create multiple subscription when subscription type is installment Subscription with non-renew agreement type when begin date and expiration date is past and frequency is Weekly with Credit Card with amount $40 .");
        setTestResultOnXRay("A30TP-38686");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD,
    ...
    public void addPaymentDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD, SUB_TYPE));
    }

    @Test
    @Description("Create multiple subscription when fist subscription as installment non-renew agreement when begin date and first due date is current date where frequency is Weekly.")
    @TmsLink("A30TP-38687")
    public void createAnotherSubs() {
        log.info("Create multiple subscription when fist subscription as installment non-renew agreement when begin date and first due date is current date where frequency is Weekly.");
        setTestResultOnXRay("A30TP-38687");
        getPage(UnoAppMemberDetailPage.class)
                .enter_installment_another_subscription_details(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD,
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_MONTHLY_CARD, SUB_CARD_HOLDER_NAME));
    }
