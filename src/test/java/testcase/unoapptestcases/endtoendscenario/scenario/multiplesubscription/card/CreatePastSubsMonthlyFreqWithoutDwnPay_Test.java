...
import static helper.AppConstants.MEMBER_FIRST_NAME;
import static helper.DataProviderSection.MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD;
...
@Issue("A30TP-13108")
@Slf4j
public class CreatePastSubsMonthlyFreqWithoutDwnPay_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD);
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void createOpenEndedSubscription() {
        ...
        setTestResultOnXRay("A30TP-38645");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD, SUB_TYPE));
    }
    ...
    public void createAnotherSubs() {
        ...
        setTestResultOnXRay("A30TP-38642");
        getPage(UnoAppMemberDetailPage.class)
                .enter_installment_another_subscription_details(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD,
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, MULTIPLE_SUBS_PAST_WITHOUT_DWNPAY_NON_RENEW_WEEKLY_CARD, SUB_CARD_HOLDER_NAME));
    }
