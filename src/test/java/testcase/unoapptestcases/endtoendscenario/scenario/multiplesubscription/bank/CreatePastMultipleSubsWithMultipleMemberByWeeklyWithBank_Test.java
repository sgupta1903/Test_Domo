...
@Issue("A30TP-13099")
@Slf4j
public class CreatePastMultipleSubsWithMultipleMemberByWeeklyWithBank_Test extends AbstractAutoUITest {
    @BeforeClass
    ...
    @Test
    @Description("Create multiple subscription, when one member getting non renewal agreement Subscription with down payment with weekly frequency and payment method as bank account")
    @TmsLink("A30TP-18499")
    public void enterDetailsForSubscription() {
        log.info("Create multiple subscription, when one member getting non renewal agreement Subscription with down payment with weekly frequency and payment method as bank account");
        setTestResultOnXRay("A30TP-18499");
    ...
    public void createAnotherSubscription() {
        ...
        getPage(UnoAppMemberDetailPage.class)
           .enter_installment_another_subscription_details(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,
