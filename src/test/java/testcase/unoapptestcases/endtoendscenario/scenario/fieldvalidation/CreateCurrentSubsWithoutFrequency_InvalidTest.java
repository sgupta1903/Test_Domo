...
@Issue("A30TP-12563")
@Slf4j
public class CreateCurrentSubsWithoutFrequency_InvalidTest extends AbstractAutoUITest {
    ...
    @Test
    @Description("Enter subscription details without frequency")
    public void enterDetailsForSubscriptionWithoutFrequency() {
        log.info("Enter subscription details without frequency");
        setTestResultOnXRay("A30TP-12566");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_without_frequency(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_PAYMENT_AMOUNT_OPENENDED_MONTHLY,
                        SUB_TYPE, SUB_DUE_DATE,ITEM_NAME,SUB_BEGIN_DATE, SUB_PAY_AMOUNT));

    }

    @Test
    @Description("Verify missing Frequency error message")
    public void verifyMissingFrequencyErrorMessage() {
        log.info("Verify missing Frequency error message");
        setTestResultOnXRay("A30TP-32562");
        getPage(UnoAppSubscriptionPage.class)
                .verify_frequency_error();
    }
    ...
    public void verifyDisabledSubmitButton() {
        ...
        setTestResultOnXRay("A30TP-12565");
        getPage(UnoAppSubscriptionPage.class)
