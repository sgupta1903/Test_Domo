...
import static helper.DataProviderSection.CURRENT_WITHOUT_PAYMENT_AMOUNT_OPENENDED_MONTHLY;
...
@Issue("A30TP-32656")
@Slf4j
public class CreateCurrentSubsWithoutBeginDate_InvalidTest extends AbstractAutoUITest {
    ...
    @Test
    @Description("Enter subscription details without begin date")
    public void enterDetailsForSubscriptionWithoutBeginDate() {
        log.info("Enter subscription details without BeginDate");
        setTestResultOnXRay("A30TP-32658");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_without_begin_date(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_PAYMENT_AMOUNT_OPENENDED_MONTHLY,
                        SUB_TYPE, SUB_DUE_DATE,ITEM_NAME, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));

    }

    @Test
    @Description("Verify missing BeginDate error message")
    public void verifyMissingBeginDateErrorMessage() {
        log.info("Verify missing BeginDate error message");
        setTestResultOnXRay("A30TP-32659");
        getPage(UnoAppSubscriptionPage.class)
                .verify_begin_date_error();
    }
    ...
    public void verifyDisabledSubmitButton() {
        ...
        setTestResultOnXRay("A30TP-32660");
        getPage(UnoAppSubscriptionPage.class)
