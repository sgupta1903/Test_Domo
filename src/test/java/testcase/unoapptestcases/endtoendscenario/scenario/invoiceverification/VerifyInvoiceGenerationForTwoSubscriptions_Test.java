...
import static helper.AppConstants.ORGWITHTWOSUBSCRIPTION;
import static helper.AppConstants.invoiceVerificationSection;

@Issue("A30TP-17394")
@Slf4j
public class VerifyInvoiceGenerationForTwoSubscriptions_Test extends AbstractAutoUITest {
    @Test
    ...
    public void searchOrganization() {
        ...
        getPage(UnoAppDashBoardPage.class)
                .search_org_name(invoiceVerificationSection, ORGWITHTWOSUBSCRIPTION);
    }
