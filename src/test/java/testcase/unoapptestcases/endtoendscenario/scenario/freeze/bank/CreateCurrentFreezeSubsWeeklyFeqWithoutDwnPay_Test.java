package testcase.unoapptestcases.endtoendscenario.scenario.freeze.bank;
...
import static helper.DataProviderSection.FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK;
...
@Issue("A30TP-36562")
@Slf4j
public class CreateCurrentFreezeSubsWeeklyFeqWithoutDwnPay_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-36563");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,
    ...
    public void createSubscription() {
        ...
        setTestResultOnXRay("A30TP-36569");
        getPage(UnoAppSubscriptionPage.class)
                .click_on_submit_btn()
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,FREEZE_CURRENT_OPENENDED_WEEKLY_WITHOUT_DWNPAY_BANK,SUB_ACCOUNT_HOLDER_NAME));
