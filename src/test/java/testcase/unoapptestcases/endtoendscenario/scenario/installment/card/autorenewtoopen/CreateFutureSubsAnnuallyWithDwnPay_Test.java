...
import static helper.DataProviderSection.FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD;
...
public class CreateFutureSubsAnnuallyWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-10770");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create 'auto-renew to open' Subscription with Credit Card when begin and expiration date future frequency Annually with downpayment")
    public void createOpenEndSubscription() {
        logger.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-11865");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create 'auto-renew to open' Subscription with Credit Card when begin future frequency Annually with downpayment")
    public void enterSubscriptionScheduleInformation() {
        logger.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-8919");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION));
    }

    @Test
    @Description("Credit Card details for subscription creation")
    public void enterCardDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-8920");
        getPage(UnoAppSubscriptionPage.class)
                .verify_subscription_created();
    }

    @Test
    @Description("Verifying that auto-renew to open subscription creation is completed")
    public void verifyAutoRenewToOpenSubscription() {
        logger.info("Verify that auto-renew to open subscription is created successfully");
        setTestResultOnXRay("A30TP-8922");
        getPage(UnoAppMemberPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,SUB_CARD_HOLDER_NAME));
    }
