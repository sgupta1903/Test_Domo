...
import static helper.DataProviderSection.FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD;
...
public class CreateFutureSubsBiweeklyWithDownPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD);
    }
    ...
    public void createLocation() {
        logger.info("Creating location for organization with valid data.");
    ...
    *//*@Test
    ...
    @Test
    @Description("Configure VANTIV processor  for the selected location for Payment Gateway.")
    public void configureMerhantForVantivProcessor() {
        logger.info("Configure VANTIV processor  for the selected location for Payment Gateway.");
    ...
    public void logoutPg() {
        logger.info("Exit from Payment Gateway");
    ...
    public void createMemberAccount() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin,first due date and expiration date is future where frequency is Weekly when auto renewal type is Non-renewal Agreement with downpayment")
    public void createNonRenewSubscription() {
        logger.info("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin,first due date and expiration date is future where frequency is Weekly when auto renewal type is Non-renewal Agreement with downpayment");
        setTestResultOnXRay("A30TP-21146");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-9553");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,
    ...
    public void verifySubscriptionCreated() {
        ...
        setTestResultOnXRay("A30TP-21155");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_NONRENEW_BIWEEKLY_CARD,SUB_CARD_HOLDER_NAME));
    }
