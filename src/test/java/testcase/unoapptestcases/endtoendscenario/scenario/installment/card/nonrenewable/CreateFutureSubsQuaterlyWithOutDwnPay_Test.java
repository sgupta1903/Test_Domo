...
import static helper.DataProviderSection.FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD;
...
public class CreateFutureSubsQuaterlyWithOutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin,first due date is past and expiration date is future where frequency is Semi-Annually when renewal type is Non-renewal Agreement")
    public void createNonRenewSubscription() {
        logger.info("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin,first due date is past and expiration date is future where frequency is Semi-Annually when renewal type is Non-renewal Agreement");
        setTestResultOnXRay("A30TP-10858");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,
    ...
    public void enterPaymentsDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,
    ...
    public void createOpenEndedSubscription() {
        logger.info("Verify the subscription created");
        setTestResultOnXRay("A30TP-14493");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_QUATERLY_CARD,SUB_CARD_HOLDER_NAME));
    }
