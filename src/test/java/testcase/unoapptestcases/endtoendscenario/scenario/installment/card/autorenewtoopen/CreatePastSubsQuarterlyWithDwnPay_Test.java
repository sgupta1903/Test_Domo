...
import static helper.DataProviderSection.PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-21577")
@Slf4j
public class CreatePastSubsQuarterlyWithDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(DataProviderSection.PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD);
    ...
    public void createProcessor() {
        log.info("Selecting the company.");
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-36331");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Enter Schedule information for the subscription with frequency as quarterly")
    @TmsLink("A30TP-36332")
    public void enterSubscriptionScheduleInformation() {
        log.info("Enter Schedule information for the subscription with frequency as quarterly");
        setTestResultOnXRay("A30TP-36332");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));

    }

    @Test
    @Description("Enter schedule Information for Installment subscription with credit card where subscription type is auto -renewal to Open and begin date is past and frequency is Quarterly.")
    @TmsLink("A30TP-36333")
    public void enterSubscriptionScheduleInstallmentInformation() {
        log.info("Enter schedule Information for Installment subscription with credit card where subscription type is auto -renewal to Open and begin date is past and frequency is Quarterly.");
        setTestResultOnXRay("A30TP-36333");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION));

    }

    @Test
    @Description("Enter renewal Information for Installment subscription with credit card where subscription type is auto -renewal to Open and begin date is past and frequency is Quarterly.")
    @TmsLink("A30TP-36334")
    public void enterSubscriptionRenewalDetails() {
        log.info("Enter renewal Information for Installment subscription with credit card where subscription type is auto -renewal to Open and begin date is past and frequency is Quarterly.");
        setTestResultOnXRay("A30TP-36334");
        getPage(UnoAppSubscriptionPage.class)
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD, SUB_RENEWAL_TYPE,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-36330");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_QUARTERLY_CARD,SUB_CARD_HOLDER_NAME));
    }
