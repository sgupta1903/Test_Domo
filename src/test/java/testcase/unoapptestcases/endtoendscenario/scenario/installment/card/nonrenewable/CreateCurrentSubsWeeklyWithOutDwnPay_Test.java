...
import static helper.DataProviderSection.CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD;
...
@Issue("A30TP-7726")
@Slf4j
public class CreateCurrentSubsWeeklyWithOutDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD);
    }
    ...
    public void configureMerchantForVantivProcessor() {
        log.info("Configure VANTIV processor  for the selected location for Payment Gateway.");
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-8944");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create non renewal agreement Subscription begin date current and frequency weekly with card ")
    @TmsLink("A30TP-9774")
    public void createNonRenewSubscription() {
        log.info("Create non renewal agreement Subscription begin date current and frequency weekly with card");
        setTestResultOnXRay("A30TP-9774");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create non renewal agreement Subscription begin and first due date current and frequency weekly with card and downpayment")
    @TmsLink("A30TP-9931")
    public void createNonRenewScheduleInformation() {
        log.info("Create non renewal agreement Subscription begin and first due date current and frequency weekly with card");
        setTestResultOnXRay("A30TP-9931");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,
    ...
    public void enterDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-9932");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_WEEKLY_CARD,SUB_CARD_HOLDER_NAME));
    }
