...
import static helper.DataProviderSection.FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK;
...
public class CreateFutureSubsWeeklyWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Installment non renewable agreement Subscription when begin date is future and frequency is weekly provided payment is done by bank account.")
    public void createNonRenewalAgreementSubscription() {
        logger.info("Create Installment non renewable agreement Subscription when begin date is future and frequency is weekly provided payment is done by bank account.");
        setTestResultOnXRay("A30TP-16653");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8906");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-16659");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_wallet_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_NONRENEW_WEEKLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
