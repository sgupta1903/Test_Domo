...
import static helper.DataProviderSection.PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK;
...
public class CreatePastSubsBiWeeklyWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-8544");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Installment Subscription with auto renew to term when Begin date is Past and frequency is BI-WEEKLY provided payment is done by bank account.")
    @TmsLink("A30TP-8537")
    public void createRenewToTermSubscription() {
        log.info("Create Installment Subscription with auto renew to term when Begin date is Past and frequency is BI-WEEKLY provided payment is done by bank account.");
        setTestResultOnXRay("A30TP-8537");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8545");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
