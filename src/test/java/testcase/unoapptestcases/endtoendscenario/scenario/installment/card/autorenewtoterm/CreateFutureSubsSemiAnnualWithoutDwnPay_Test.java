...
import static helper.DataProviderSection.PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD;
...
public class CreateFutureSubsSemiAnnualWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create auto-renew to term Subscription with 'Credit Card' when begin,first due date and expiration date is future" +
            " where frequency Semi-Annually with downpayment")
    public void createAutoRenewToTermDwnpymtSubscription() {
        logger.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-10861");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,
    ...
    public void enterCardDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_SEMIANNUALLY_CARD,SUB_CARD_HOLDER_NAME));
    }
