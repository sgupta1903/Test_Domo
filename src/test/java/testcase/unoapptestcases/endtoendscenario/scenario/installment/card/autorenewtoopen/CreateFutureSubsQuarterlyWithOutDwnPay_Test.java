...
import static helper.DataProviderSection.FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD;
...
public class CreateFutureSubsQuarterlyWithOutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        set_section_name(FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-9128");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create auto-renewal to open subscription and begin date is future date and frequency is Quarterly when payment is done by Card.")
    public void createRenewToOpenSubscription() {
        logger.info("Create auto-renewal to open subscription and begin date is future date and frequency is Quarterly when payment is done by Card.");
        setTestResultOnXRay("A30TP-9131");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION));
    }

    @Test
    @Description("Card details for subscription creation")
    public void enterDetailsForSubscription() {
        logger.info("Entering the Card details");
        setTestResultOnXRay("A30TP-9130");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,
    ...
    public void verifySubscriptionCreated() {
        ...
        setTestResultOnXRay("A30TP-19271");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_QUATERLY_CARD,SUB_CARD_HOLDER_NAME));
    }
