...
import static helper.DataProviderSection.PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK;
...
@Issue("A30TP-10802")
@Slf4j
public class CreatePastSubsWeeklyWithDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK);
    }
    ...
    @Test
    @Description("Configuring Merchant EFT processorfor the selected location for Payment Gateway.")
    @TmsLink("A30TP-20722")
    ...
    public void createItemCategory() {
        ...
        setTestResultOnXRay("A30TP-8243");
    ...
    public void createItem() {
        ...
        setTestResultOnXRay("A30TP-8237");
    ...
    public void createPrimaryMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create 'Non-renewal Agreement' Subscription with 'Bank_Account' when begin,first due date past and exp date future frequency Weekly with downpayment")
    @TmsLink("A30TP-10871")
    public void enterSubscriptionScheduleInformationForNonRenew() {
        log.info("Create 'Non-renewal Agreement' Subscription with 'Bank_Account' when begin,first due date past and exp date future frequency Weekly with downpayment");
        setTestResultOnXRay("A30TP-10871");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,
    ...
    @TmsLink("A30TP-8418")
    public void enterPaymentDetailsForSubscription() {
        log.info("Entering the details of bank account ");
        setTestResultOnXRay("A30TP-8418");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_NONRENEW_WEEKLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
