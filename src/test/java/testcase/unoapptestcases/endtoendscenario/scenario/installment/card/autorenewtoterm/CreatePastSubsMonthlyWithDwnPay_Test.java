...
import static helper.DataProviderSection.PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-11861")
@Slf4j
public class CreatePastSubsMonthlyWithDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        setTestResultOnXRay("A30TP-14514");
        set_section_name(PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-11862");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-11863");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Installment subscription where subscription type is auto-renew to Term and begin and due date is past and frequency is monthly when payment is done by Card with downpayment")
    @TmsLink("A30TP-11864")
    public void createAutoRenewToTermSubscription() {
        log.info("Create Installment subscription where subscription type is auto-renew to Term and begin and due date is past and frequency is monthly when payment is done by Card with downpayment");
        setTestResultOnXRay("A30TP-11864");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,
    ...
    public void enterPaymentsDetailsForSubscription() {
        log.info("Entering the details of card account ");
        setTestResultOnXRay("A30TP-8418");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_MONTHLY_CARD,SUB_CARD_HOLDER_NAME));
    }
