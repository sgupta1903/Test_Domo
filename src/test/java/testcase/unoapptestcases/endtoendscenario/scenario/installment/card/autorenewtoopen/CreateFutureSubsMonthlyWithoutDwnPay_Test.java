...
import static helper.DataProviderSection.FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD;
...
public class CreateFutureSubsMonthlyWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD);
    }
    ...
    public void configuringMerchantForVantivProcessor() {
        logger.info("Creating a merchant processor for the location.");
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Installment subscription where subscription type is auto-renewal to open and begin date is future date and frequency is monthly without down payment when payment is done by credit card.")
    public void createRenewToOpenSubscription() {
        logger.info("Create Installment subscription where subscription type is auto-renewal to open and begin date is future date and frequency is monthly without down payment when payment is done by credit card.");
        setTestResultOnXRay("A30TP-36459");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD, SUB_RENEWAL_TYPE,
                        SUB_RENEWAL_DATE, SUB_RENEWAL_FREQUENCY));
    }

    @Test
    @Description("Enter Payement details and click on submit button.")
    public void enterCardDetailsForSubscription() {
        logger.info("Entering the details of credit and click on submit button.");
        setTestResultOnXRay("A30TP-32325");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
    ...
    public void verifySubscriptionCreated() {
        logger.info("Verifying the subscription created successfully with valid data.");
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_CARD_HOLDER_NAME));
    }
