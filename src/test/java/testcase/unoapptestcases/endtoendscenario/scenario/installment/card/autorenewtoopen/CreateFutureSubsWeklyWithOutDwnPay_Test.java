...
import static helper.DataProviderSection.FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-21282")

public class CreateFutureSubsWeklyWithOutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create auto-renewal to open subscription begin date is future date and frequency is weekly without downpayment when payment is done by credit card")
    public void createAutoRenewToOpenSubscription() {
        logger.info("Create auto-renewal to open subscription begin date is future date and frequency is weekly without downpayment when payment is done by credit card");
        setTestResultOnXRay("A30TP-36592");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD, SUB_RENEWAL_TYPE,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-36593");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD, SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_CARD, SUB_CARD_HOLDER_NAME));
    }
