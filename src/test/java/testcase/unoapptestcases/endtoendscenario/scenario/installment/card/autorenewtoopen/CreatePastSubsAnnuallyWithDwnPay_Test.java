...
import static helper.DataProviderSection.PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD;
...
public class CreatePastSubsAnnuallyWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
                        SUB_DOWNPAYMENT));

    }

    @Test
    @Description("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin date is past and expiration date is future date where frequency is Annually when installment type is 'auto-renew to open' without down payment.")
    @TmsLink("A30TP-32413")
    public void createRenewToOpenSubscription() {
        log.info("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin date is past and expiration date is future date where frequency is Annually when installment type is 'auto-renew to open' without down payment.");
        setTestResultOnXRay("A30TP-32413");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD, SUB_RENEWAL_TYPE,
    ...
    public void enterCardDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-32414");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD,SUB_CARD_HOLDER_NAME));
    }
