...
public class CreatePastSubsQuarterlyWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD);
    }
    ...
    public void createMemberAccount() {
        ...
        setTestResultOnXRay("A30TP-38669");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void createNonRenewSubscription() {
        ...
        setTestResultOnXRay("A30TP-38665");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD,
    ...
    public void enterPaymentsDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-38666");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD,
    ...
    public void verifySubscriptionCreated() {
        ...
        setTestResultOnXRay("A30TP-38667");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD, SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_NONRENEW_QUARTERLY_CARD, SUB_CARD_HOLDER_NAME));
    }
