...
import static helper.DataProviderSection.CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD;
...
public class CreateCurrentSubsAnnuallyWithOutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-9570");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create non renewal agreement Subscription begin date current and frequency weekly with card and downpayment")
    @TmsLink("A30TP-9391")
    public void createNonRenewSubscription() {
        log.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-9391");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create non renewal agreement Subscription begin and first due date current and frequency weekly with card")
    @TmsLink("A30TP-21098")
    public void enterSubscriptionScheduleInformation() {
        log.info("Create non renewal agreement Subscription begin and first due date current and frequency weekly with card");
        setTestResultOnXRay("A30TP-21098");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION));
    }

    @Test
    @Description("Enter Payment Information as Credit Card details for subscription creation")
    @TmsLink("A30TP-42970")
    public void enterDetailsForSubscription() {
        log.info("Enter Payment Information as Credit Card details for subscription creation");
        setTestResultOnXRay("A30TP-42970");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,
    ...
    public void verifySubscriptionCreation() {
        log.info("Verify the subscription created successfully");
        setTestResultOnXRay("A30TP-42971");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_NONRENEW_ANNUALLY_CARD,SUB_CARD_HOLDER_NAME));
    }
