...
import static helper.DataProviderSection.PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE;
...
@Issue("A30TP-21581")
@Slf4j
public class CreatePastSubsAnnuallyWithDwnPayExpDateFuture_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE);
    }
    ...
    public void logoutPg() {
        log.info("Exit from Payment Gateway and switch to create member for billing.");
    ...
    @Test
    @Description("Create auto-renewal to open subscription where begin date is past and exp date is future and frequency Annually with Card")
    @TmsLink("A30TP-36550")
    public void createRenewToOpenSubscription() {
        log.info("Create auto-renewal to open subscription where begin date is past and exp date is future and frequency Annually with Card");
        setTestResultOnXRay("A30TP-36550");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE,
                        SUB_DOWNPAYMENT))
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE, SUB_RENEWAL_TYPE,
    ...
    public void enterCardDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-36551");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE, SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_AUTORENEWTOOPEN_ANNUALLY_CARD_EXP_DATE_FUTURE, SUB_CARD_HOLDER_NAME));
    }
