...
import static helper.DataProviderSection.PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-11874")
@Slf4j
public class CreatePastSubsBiWeeklyWithOutDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD);
    }
    ...
    public void createMember() {
        log.info("Creating the member in the uno app ");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterScheduleInfo() {
        log.info("Entering the installment type of subscription and its details");
        setTestResultOnXRay("A30TP-11885");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,
    ...
    public void createSubsAutoRenewToTermType() {
        log.info("Entering details for Auto renew to Term Type and verifying the subscription creation");
        setTestResultOnXRay("A30TP-11886");
        getPage(UnoAppSubscriptionPage.class)
                .enter_renewal_auto_to_term();
    }

    @Test
    @Description("Enter subscription details and payment data while creating subscription")
    @TmsLink("A30TP-11884")
    public void enterSubscriptionDetailsAndPaymentInfo() {
        log.info("Creation of Subscription has started");
        setTestResultOnXRay("A30TP-11884");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_AUTORENEWTOTERM_BIWEEKLY_CARD,SUB_CARD_HOLDER_NAME));
    }
