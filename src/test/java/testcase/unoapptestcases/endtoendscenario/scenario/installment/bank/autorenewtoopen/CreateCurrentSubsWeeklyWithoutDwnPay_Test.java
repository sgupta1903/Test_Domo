...
import static helper.DataProviderSection.CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK;
...
public class CreateCurrentSubsWeeklyWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Installment subscription where subscription type is auto-renewal to open and begin date is current date and frequency is Weekly when payment is done by Bank account")
    @TmsLink("A30TP-8834")
    public void createRenewToOpenSubscription() {
        log.info("Create Installment subscription where subscription type is auto-renewal to open and begin date is current date and frequency is Weekly when payment is done by Bank account");
        setTestResultOnXRay("A30TP-8834");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK, SUB_RENEWAL_TYPE,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8530");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,
    ...
    public void verifySubscriptionCreated() {
        ...
        setTestResultOnXRay("A30TP-9247");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_AUTORENEWTOOPEN_WEEKLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
