...
import static helper.DataProviderSection.PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK;
...
public class CreatePastSubsMonthlyWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-9249");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create non-renewal subscription frequency monthly begin date past and expiration date future date with bank account")
    @TmsLink("A30TP-9574")
    public void createNonRenewalSubscription() {
        log.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-9574");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create non-renewal subscription frequency monthly begin date past date with bank account")
    @TmsLink("A30TP-9576")
    public void createNonRenewalSubscriptionWithMonthlyFreq() {
        log.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-9576");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,
    ...
    public void enterPaymentsDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-9573");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,
    ...
    @TmsLink("A30TP-9577")
    public void verifyNonRenewalSubscriptionCreation() {
        log.info("Verify that subscription is created successfully");
        setTestResultOnXRay("A30TP-9577");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscription() {
        log.info("Verify that subscription is created successfully");
        setTestResultOnXRay("A30TP-9578");
        getPage(UnoAppMemberPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_NONRENEW_MONTHLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
