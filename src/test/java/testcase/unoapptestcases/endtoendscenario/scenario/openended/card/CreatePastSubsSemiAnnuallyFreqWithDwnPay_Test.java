...
@Issue("A30TP-7762")
@Slf4j
public class CreatePastSubsSemiAnnuallyFreqWithDwnPay_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(DataProviderSection.PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD);
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-8968");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD,
                        SUB_DOWNPAYMENT))
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));

    }

    @Test
    @Description("Create Open Ended Subscription when begin date is Past and frequency is SEMI-ANNUALLY when payment is done by credit card")
    @TmsLink("A30TP-8972")
    public void createNonRenewSubscription() {
        log.info("Create Open Ended Subscription when begin date is Past and frequency is SEMI-ANNUALLY when payment is done by credit card");
        setTestResultOnXRay("A30TP-8972");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD,
    ...
    @Test
    @Description("Verifying the subscription created with valid data")
    @TmsLink("A30TP-8971")
    public void verifySubscriptionCreated() {
        log.info("Verifying the subscription created with valid data.");
        setTestResultOnXRay("A30TP-8971");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY_CARD,SUB_CARD_HOLDER_NAME));
    }
