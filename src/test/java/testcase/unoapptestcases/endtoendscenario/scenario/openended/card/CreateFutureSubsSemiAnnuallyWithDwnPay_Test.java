...
import static helper.DataProviderSection.FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD;
...
public class CreateFutureSubsSemiAnnuallyWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-15898");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD,
                        SUB_CARD_NUMBER, SUB_CARD_HOLDER_NAME, SUB_CARD_EXPIRY_YEAR, SUB_CARD_POSTAL_CODE));
    }

    @Test
    @Description("Create open ended subscription with down payment and frequency as semi-annually with begin date as future date provided payment is done by card.")
    public void createOpenEndedSubscription() {
        logger.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-15900");
        getPage(UnoAppSubscriptionPage.class)
                .click_on_submit_btn()
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENEND_SEMIANNUALLY_CARD,SUB_CARD_HOLDER_NAME));
    }
