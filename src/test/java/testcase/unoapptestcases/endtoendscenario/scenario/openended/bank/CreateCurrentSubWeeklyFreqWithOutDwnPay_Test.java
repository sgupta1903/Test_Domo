...
@Issue("A30TP-7849")
@Slf4j
public class CreateCurrentSubWeeklyFreqWithOutDwnPay_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {

        set_section_name(CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-8802");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8798");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,
                        SUB_ACCOUNT_HOLDER_NAME, SUB_BANK_ROUTING_NUMBER, SUB_BANK_ACCOUNT_NUMBER));
    }

    @Test
    @Description("Create Open Ended Subscription when begin date is Current date and frequency is weekly when payment is done by bank account")
    @TmsLink("A30TP-8803")
    public void createSubscription() {
        log.info("Create Open Ended Subscription when begin date is Current date and frequency is weekly when payment is done by bank account");
        setTestResultOnXRay("A30TP-8803");
        getPage(UnoAppSubscriptionPage.class)
                .click_on_submit_btn()
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_WITHOUT_DWNPAY_OPENENDED_WEEKLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
