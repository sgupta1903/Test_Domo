...
import static helper.DataProviderSection.PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY;
...
@Issue("A30TP-7848")
@Slf4j
public class CreatePastSubsAnnuallyFreqWithoutDwnPay_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(DataProviderSection.PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY);
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-8269");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Open Ended Subscription when begin date is Past and frequency is Annually when payment is done by Bank account")
    @TmsLink("A30TP-8884")
    public void createSubscription() {
        log.info("Create Open Ended Subscription when begin date is Past and frequency is Annually when payment is done by Bank account");
        setTestResultOnXRay("A30TP-8884");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8883");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-8885");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_ANNUALLY,SUB_ACCOUNT_HOLDER_NAME));
