...
@Issue("A30TP-7704")
@Slf4j
public class CreatePastSubMonthlyFreqWithoutDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Open Ended Subscription for a member with down payment and begin date and frequency is monthly in past provided payment is done by bank account.")
    @TmsLink("A30TP-8696")
    public void createSubscription() {
        log.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-8696");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,
    ...
    public void enterDetailsForSubscription() {
        log.info("Entering the details of credit account for member.");
        setTestResultOnXRay("A30TP-8689");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,
    ...
    public void verifySubscriptionCreation() {
        log.info("Verify that subscription is created successfully for a member.");
        setTestResultOnXRay("A30TP-8692");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_MONTHLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
