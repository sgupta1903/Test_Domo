...
public class CreateFutureSubsAnnuallyFreqWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-9104");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Open Ended Subscription with DwnPay begin date Future frequency Annually with bank account.")
    public void createSubscription() {
        logger.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-9107");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-9110");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_wallet_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_ANUALLY,SUB_ACCOUNT_HOLDER_NAME));
