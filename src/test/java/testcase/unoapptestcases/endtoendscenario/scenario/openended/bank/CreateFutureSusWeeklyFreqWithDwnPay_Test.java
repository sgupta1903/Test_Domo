...
public class CreateFutureSusWeeklyFreqWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-8441");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create open-ended subscription with dwn payment where begin and due date date is future date and frequency is weekly payment is done by bank .")
    public void createSubscription() {
        logger.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-8451");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,
    ...
    public void enterDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_wallet_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITH_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,SUB_ACCOUNT_HOLDER_NAME));
