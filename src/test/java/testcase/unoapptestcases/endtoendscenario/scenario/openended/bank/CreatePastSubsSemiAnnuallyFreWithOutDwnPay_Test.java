...
@Issue("A30TP-7783")
@Slf4j
public class CreatePastSubsSemiAnnuallyFreWithOutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Open-Ended Subscription for member when begin date is in past with frequency semi annually when payment is done by bank account")
    @TmsLink("A30TP-9114")
    public void createNonRenewSubscription() {
        log.info("Create Open-Ended Subscription for member when begin date is in past with frequency semi annually when payment is done by bank account");
        setTestResultOnXRay("A30TP-9114");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8964");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,
    ...
    public void verifySubscriptionCreated() {
        ...
        setTestResultOnXRay("A30TP-9216");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITHOUT_DWNPAY_OPENENDED_SEMIANNUALLY,SUB_ACCOUNT_HOLDER_NAME));
