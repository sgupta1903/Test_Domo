...
import static helper.DataProviderSection.PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD;
import static util.UtilityGeneric.set_section_name;


@Issue("A30TP-7857")
@Slf4j
public class CreatePastSubsMonthlyFreqWithDwnPayByCard_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Open Ended Subscription with down payment begin date Past and frequency Monthly with credit card")
    @TmsLink("A30TP-8318")
    public void enterSubscriptionScheduleInformation() {
        log.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-8318");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8316");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_MONTHLY_CARD,SUB_CARD_HOLDER_NAME));
    }
