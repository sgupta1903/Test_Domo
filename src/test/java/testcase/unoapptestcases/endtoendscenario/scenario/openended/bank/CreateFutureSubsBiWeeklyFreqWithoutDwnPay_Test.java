...
Date : 29/07/2019
Updated Date : 10/17/2019
*/

@Issue("A30TP-7881")
@Test
public class CreateFutureSubsBiWeeklyFreqWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY);
    }
    ...
    @Test
    @Description("Displaying existing processor for company.")
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8148");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Open Ended Subscription when begin date is Future and frequency is BI-WEEKLY provided payment is done by bank account.")
    public void createSubscription() {
        logger.info("Create Open Ended Subscription when begin date is Future and frequency is BI-WEEKLY provided payment is done by bank account.");
        setTestResultOnXRay("A30TP-8181");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_wallet_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_BIWEEKLY,SUB_ACCOUNT_HOLDER_NAME));
