...
import static helper.DataProviderSection.PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD;
import static util.UtilityGeneric.set_section_name;


@Issue("A30TP-7854")
@Slf4j
public class CreatePastSubsWeeklyFreWithDwnPay_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD);
    }
    ...
    @Test
    @Description("Fill all the details in information page")
    @TmsLink("A30TP-8960")
    public void enterMemebrDetails() {
        log.info("Member creation has started");
        setTestResultOnXRay("A30TP-8960");
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-8310");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create 'Open-End' Subscription with 'Credit Card' begin and due date past frequency semi-annually with down payment.")
    @TmsLink("A30TP-8312")
    public void enterSubscriptionScheduleInformation() {
        log.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-8312");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8419");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-8309");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_WEEKLY_CARD,SUB_CARD_HOLDER_NAME));
    }
