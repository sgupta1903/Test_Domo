...
public class CreateFutureSubsMonthlyFreqWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK);
    }
    ...
    @Test
    @Description("Creating processor configuration for the selected location on Payment Gateway.")
    public void configuringMerchantEFTProcessor() {
        logger.info("Create merchant account .");
    ...
    public void createSubsWithOneMember() {
        ...
        setTestResultOnXRay("A30TP-9230");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,
                        SUB_DOWNPAYMENT));

    }

    @Test
    @Description("Create Subscription with member")
    public void createSubscription() {
        logger.info("Subscription creation has started with member creation");
        setTestResultOnXRay(" A30TP-14160");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_wallet_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_MONTHLY_DUE_DATE_FUTURE_BANK,SUB_ACCOUNT_HOLDER_NAME));
