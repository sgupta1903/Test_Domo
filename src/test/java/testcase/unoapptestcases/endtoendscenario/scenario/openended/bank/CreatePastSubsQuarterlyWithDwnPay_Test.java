...
public class CreatePastSubsQuarterlyWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Open Ended Subscription begin date Past and frequency QUARTERLY with bank account")
    @TmsLink("A30TP-8997")
    public void enterSubscriptionScheduleInformation() {
        log.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-8997");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8995");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,
    ...
    public void verifySubscriptionCreation() {
        ...
        setTestResultOnXRay("A30TP-8999");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_WITH_DWNPAY_OPENENDED_QUARTERLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
