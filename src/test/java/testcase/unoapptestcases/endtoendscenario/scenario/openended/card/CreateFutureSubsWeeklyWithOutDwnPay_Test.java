...
import static helper.DataProviderSection.FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD;
...
public class CreateFutureSubsWeeklyWithOutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD);
    }
    ...
    public void enterPaymentInfo() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD,
                        SUB_DOWNPAYMENT))
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD,
    ...
    public void enterScheduleInfo() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD,
    ...
    public void createSubsAutoRenewToTermType() {
        ...
        setTestResultOnXRay("A30TP-8265");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENENDED_WEEKLY_CARD,SUB_CARD_HOLDER_NAME));
    }
