...
import static helper.DataProviderSection.FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD;
...
public class CreateFutureSubsQuaterlyFreqWithoutDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD);
    }
    ...
    public void createProcessor() {
        logger.info("Creating the processor for company.");
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Open Ended Subscription when begin date Future and frequency Quarterly with 'Credit Card'.")
    public void enterSubscriptionScheduleInformation() {
        logger.info("Entering the details related to Subscription schedule");
        setTestResultOnXRay("A30TP-8262");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-8260");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,FUTURE_WITHOUT_DWNPAY_OPENEND_QUARTERLY_CARD,SUB_CARD_HOLDER_NAME));
    }
