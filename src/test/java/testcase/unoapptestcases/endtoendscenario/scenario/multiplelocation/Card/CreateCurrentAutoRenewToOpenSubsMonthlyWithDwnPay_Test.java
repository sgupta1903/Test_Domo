...
import static helper.DataProviderSection.CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD;
...
@Issue("A30TP-22014")
@Slf4j
public class CreateCurrentAutoRenewToOpenSubsMonthlyWithDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD);
    }
    ...
    public void enterMemberDetailsForFirstLocation() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterRenewToOpenSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Renew-to-open Subscription with credit card for past and frequency Semi-Annually for location first.")
    @TmsLink("A30TP-31953")
    public void createNonRenewSubscription() {
        log.info("Create Installment subscription with 1st location is align with one organization where subscription type is renew-to open frequency is monthly and payment method is credit card where begin date is current and expiration date is future.");
        setTestResultOnXRay("A30TP-31953");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD, SUB_RENEWAL_TYPE,
    ...
    public void enterDetailsForSubscription() {
        log.info("Create Installment subscription with 1st location is align with one organization where subscription type is renew-to open frequency is monthly and payment method is credit card when begin date is current and due date is future with down pay.");
        setTestResultOnXRay("A30TP-31954");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_CARD_HOLDER_NAME));
    }
    ...
    @Test
    @Description("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open begin date is current and frequency is monthly and payment method is credit card and expiration date is future with down pay. ")
    @TmsLink("30TP-31956")
    public void enterSubscriptionForSecondLcoation() {
        log.info("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open begin date is current and frequency is monthly and payment method is credit card and expiration date is future with down pay.");
        setTestResultOnXRay("A30TP-31956");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
    ...
    @Test
    @Description("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open frequency is monthly and payment method is credit card when begin date is current and expiration date is future.")
    @TmsLink("A30TP-31957")
    public void enterCardDetails() {
        log.info("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open frequency is monthly and payment method is credit card when begin date is current and expiration date is future.");
        setTestResultOnXRay("A30TP-31957");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,
                        SUB_CARD_NUMBER, SUB_CARD_HOLDER_NAME, SUB_CARD_EXPIRY_YEAR, SUB_CARD_POSTAL_CODE))
                .click_on_submit_btn()
    ...
    public void verifySubscriptionTabForSecondLocation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_WITHDWNPAY_AUTORENEWTOOPEN_MONTHLY_CARD,SUB_TYPE));
    }
