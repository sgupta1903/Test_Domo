...
import static helper.DataProviderSection.CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY;
...
public class CreateFutureAutoRenewToOpenSubsAnnuallyWithDwnPay_Test extends AbstractAutoUITest {
    ...
    public void setSectionData() {
        ...
        set_section_name(CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY);
    }
    ...
    public void createLocation() {
        logger.info("Creating first location for oranization with valid data.");
    ...
    public void createSecondLocation() {
        logger.info("Creating second location for organization with valid data.");
    ...
    public void addBankingDetailsForSecondLocation() {
        logger.info("Creating second location for oranization with valid data.");
    ...
    public void displayProcessor() {
        logger.info("Displaying the processor for company.");
    ...
    public void configuringMerchant() {
        logger.info("Creating EFT processor configuration for the first location on Payment Gateway.");
    ...
    public void creatingMerchantAccountForSecondLocation() {
        logger.info("Creating EFT processor configuration for the second location on Payment Gateway.");
    ...
    public void selectAddMember() {
        logger.info("Selecting add member page for first location");
    ...
    public void enterMemberDetailsForFirstLocation() {
        ...
        setTestResultOnXRay("A30TP-32184");
        getPage(UnoAppMemberPage.class)
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create Non-Renewal agreement Subscription with Bank_Account.")
    public void enterNonRenewSubscription() {
        logger.info("Create Renew-to-open Subscription with credit card");
        setTestResultOnXRay("A30TP-32186");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,
    ...
    public void createNonRenewSubscription() {
        logger.info("Create Non-Renewal agreement Subscription with Bank_Account for past and frequency Annually.");
        setTestResultOnXRay("A30TP-31177");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY, SUB_RENEWAL_TYPE,
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-31178");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,SUB_CARD_HOLDER_NAME));
    }
    ...
    public void selectaddMemberForSecondLocation() {
        logger.info("Selecting add member page for second location");
    ...
    public void selectAddMemberButton() {
        logger.info("Selecting add member page details for second location");
    ...
    @Test
    @Description("Create Subscription for second location and enter the member details for second lcoation")
    public void enterMemberDetailsForSecondLcoation() {
        logger.info("Subscription creation has started with member creation for second location");
    ...
    @Test
    @Description("Create Installment subscription with 2nd location is align with one organization where subscription type is renew-to open frequency is annually and payment method is credit card.")
    public void enterSubscriptionForSecondLcoation() {
        logger.info("Create Installment subscription with 2nd location is align with one organization where subscription type is renew-to open frequency is annually and payment method is credit card");
        setTestResultOnXRay("A30TP-32207");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,
                        SUB_TYPE, SUB_DUE_DATE, SECOND_ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Installment subscription with 2nd location is align with one organization where subscription type is renew-to open frequency is annually and payment method is credit card when begin date is current and due date is future.")
    public void createSubscriptionForSecondLocation() {
        logger.info("Create Installment subscription with 2nd location is align with one organization where subscription type is renew-to open frequency is annually and payment method is credit card when begin date is current and due date is future.");
        setTestResultOnXRay("A30TP-32208");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY, SUB_RENEWAL_TYPE,
    ...
    public void verifySubscriptionTabForSecondLocation() {
        logger.info("Verify that subscription tab for subscription created for a member in second location");
        setTestResultOnXRay("A30TP-12064");
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_FUTURE_AUTORENEWTOOPEN_ANNUALLY_ANNUAL_CARD_DWN_PAY,SUB_TYPE));
    }
    ...
    public void verifyAgreementTabForSecondLocation() {
        logger.info("Verify that agreement tab for subscription created for a member in second location");
    ...
    public void verifyWalletTabForSecondLcoation() {
        logger.info("Verify that wallet tab for subscription created for a member in second location");
    ...
    public void verifyProfileTabForSecondLocation() {
        logger.info("Verify that profile tab for subscription created for a member in second location");
    ...
    public void verifyNotesTabForSecondLocation() {
        logger.info("Verify that notes tab for subscription created for a member of second location");
