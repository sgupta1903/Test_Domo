...
import static helper.DataProviderSection.PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-12102")
@Slf4j
public class CreatePastNonRenewableSubsYearly_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK);
    }
    ...
    @Test
    @Description("Exit from Payment Gateway.")
    @TmsLink("A30TP-12693")
    ...
    public void selectAddMember() {
        ...
        setTestResultOnXRay("A30TP-12140");
    ...
    public void enterMemberDetailsForFirstLocation() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterNonRenewSubscriptionDetails() {
        ...
        setTestResultOnXRay("A30TP-12134");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,
    ...
    public void createNonRenewSubscription() {
        ...
        setTestResultOnXRay("A30TP-12132");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,
    ...
    public void enterDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
    ...
    @TmsLink("A30TP-15984")
    public void aAdMemberForSecondLocation() {
        log.info("Selecting add member page for second location");
        setTestResultOnXRay("A30TP-15984");
        getPage(UnoAppMemberPage.class)
                .navigate_and_click_add_member_btn();
    }
    ...
    @Test
    @Description("Entering schedule information")
    @TmsLink("30TP-15967")
    public void enterScheduleInformation() {
        log.info("Entering schedule information for non renewable subscription");
        setTestResultOnXRay("A30TP-15967");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_for_second_location(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, SECOND_ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Non-Renewal agreement Subscription with Bank_Account for past frequency Annually for second location.")
    @TmsLink("A30TP-12109")
    public void createSubscriptionforSecondLocation() {
        log.info("Create Non-Renewal agreement Subscription with Bank_Account for past and frequency Annually for second location.");
        setTestResultOnXRay("A30TP-12109");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,
                        SUB_EXPIRY_DATE, SUB_DURATION));
    }
    ...
    public void verifySubscriptionTabForSecondLcoation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_NONRENEW_YEARLY_BANK,SUB_TYPE));
    }
