...
import static helper.DataProviderSection.CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-30729")
@Slf4j
public class CreateCurrentAutoRenewToTermSubsMonthlyWithDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD);
    }
    ...
    @Test
    @Description("Configure Merchant for Vantiv processor for the first location on Payment Gateway.")
    @TmsLink("A30TP-20723")
    public void configuringMerchantForVantivProcessor() {
        log.info("Configure Merchant for Vantiv processor for the first location on Payment Gateway.");
    ...
    @Test
    @Description("Configure Merchant for Vantiv processor  for second location for Payment Gateway.")
    @TmsLink("A30TP-15917")
    public void creatingMerchantAccountForSecondLocation() {
        log.info("\"Configure Merchant for Vantiv processor  for the second location on Payment Gateway.");
    ...
    @Test
    @Description("Subscription creation has started with member creation for first location and enter the member details")
    @TmsLink("A30TP-15944")
    public void enterMemberDetailsForFirstLocation() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Enter Auto Renew to Term agreement Subscription details.")
    @TmsLink("A30TP-12093")
    public void enterSubscriptionDetails() {
        log.info("Enter Auto Renew to Term agreement Subscription details");
        setTestResultOnXRay("A30TP-12093");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Auto Renew to Term agreement subscription with Card and frequency Monthly.")
    @TmsLink("A30TP-12063")
    public void createRenewToTermSubscription() {
        log.info("Create Auto Renew to Term agreement subscription with Card and frequency Monthly");
        setTestResultOnXRay("A30TP-12063");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,
    ...
    public void enterCardDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,SUB_CARD_HOLDER_NAME));
    }
    ...
    @Test
    @Description("Enter subscription information  for second location.")
    @TmsLink("A30TP-12062")
    public void enterSubscriptionForSecondLcoation() {
        log.info("Enter subscription information  for second location.");
        setTestResultOnXRay("A30TP-12062");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, SECOND_ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Auto Renew to Term agreement Subscription with Card for current frequency Monthly for second location.")
    @TmsLink("A30TP-12116")
    public void createSubscriptionForSecondLocation() {
        log.info("Create Auto Renew to Term agreement Subscription with Card for current frequency Monthly for second location.");
    ...
    public void enterCardDetails() {
        log.info("Entering the details of credit for second location ");
    ...
    public void verifySubscriptionTabForSecondLocation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_MONTHLY_WITH_DWN_PAY_CARD,SUB_TYPE));
    }
