...
import static helper.DataProviderSection.PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK;
...
@Issue("A30TP-12015")
@Slf4j
public class CreatePastOpenEndedSubsMonthly_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK);
    }
    ...
    public void selectAddMember() {
        ...
        setTestResultOnXRay("A30TP-12052");
    ...
    public void enterMemberDetailsForFirstLocation() {
        ...
        setTestResultOnXRay("A30TP-12022");
        getPage(UnoAppMemberPage.class)
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Enter Open-ended agreement Subscription Details ")
    @TmsLink("A30TP-12026")
    public void enterOpenEndedSubscriptionDetails() {
        log.info("Enter Open-ended agreement Subscription Details");
        setTestResultOnXRay("A30TP-12026");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Enter Bank details for subscription")
    @TmsLink("A30TP-12024")
    public void enterDetailsForSubscription() {
        log.info("Enter Bank details for subscription");
        setTestResultOnXRay("A30TP-12024");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,
    ...
    public void verifySubscriptionCreatedForFirstLocation() {
        ...
        setTestResultOnXRay("A30TP-12028");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
    }
    ...
    public void selectAddMemberForSecondLocation() {
        ...
        setTestResultOnXRay("A30TP-16394");
        getPage(UnoAppMemberPage.class)
                .navigate_and_click_add_member_btn();
    }
    ...
    @Test
    @Description("Subscription creation has started with member creation for second location")
    @TmsLink("A30TP-15962")
    ...
    @Test
    @Description("Enter Open-Ended subscription Details for second location with Bank_Account for past frequency Monthly for second location.")
    @TmsLink("A30TP-16396")
    public void createSubscriptionForSecondLocation() {
        log.info("Enter Open-Ended subscription Details for second location with Bank_Account for past and frequency Monthly for second location.");
        setTestResultOnXRay("A30TP-16396");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_for_second_location(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, SECOND_ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Enter Open-Ended subscription Details for second location")
    @TmsLink("A30TP-16395")
    public void enterBankingDetails() {
        log.info("Enter Open-Ended subscription Details for second location");
        setTestResultOnXRay("A30TP-16395");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,
                        SUB_ACCOUNT_HOLDER_NAME, SUB_BANK_ROUTING_NUMBER, SUB_BANK_ACCOUNT_NUMBER))
                .click_on_submit_btn();
    ...
    public void verifySubscriptionCreatedForSecondLocation() {
        ...
        setTestResultOnXRay("A30TP-12050");
        getPage(UnoAppSubscriptionPage.class)
                .verify_subscription_created();
        getPage(UnoAppMemberPage.class)
    ...
    public void verifySubscriptionTabForSecondLcoation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPENENDED_MONTHLY_BANK,SUB_TYPE));
    }
