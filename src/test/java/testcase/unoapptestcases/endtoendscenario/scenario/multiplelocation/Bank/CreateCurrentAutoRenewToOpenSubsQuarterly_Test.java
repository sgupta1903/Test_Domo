...
import static helper.DataProviderSection.CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-12066")
@Slf4j
public class CreateCurrentAutoRenewToOpenSubsQuarterly_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK);
    }
    ...
    @Test
    @Description("Signin into the payment gateway")
    @TmsLink("A30TP-12686")
    public void loginPaymentGateway() {
        log.info("Signin into payment gateway with valid credential.");
    ...
    public void enterMemberDetailsForFirstLocation() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Enter subscription schedule section information")
    @TmsLink("A30TP-12070")
    public void enterSubscriptionScheduleDetails() {
        log.info("enter subscription schedule information");
        setTestResultOnXRay("A30TP-12070");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Enter schedule information for installment subscription and auto renew to open details")
    @TmsLink("A30TP-34367")
    public void createRenewToOpenSubscription() {
        log.info("Enter schedule and auto renew to open information for installment subscription");
        setTestResultOnXRay("A30TP-34367");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK, SUB_RENEWAL_TYPE,
    ...
    public void enterCardDetailsForSubscription() {
        log.info("Entering the details of bank account and then clicking submit button for creating the subscription ");
        setTestResultOnXRay("A30TP-34369");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
    }
       /*
    ...
    public void enterSubscriptionForSecondLcoation() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,
    ...
    public void verifySubscriptionTabForSecondLocation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_BANK,SUB_TYPE));
    }
