...
import static helper.DataProviderSection.CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY;
...
@Issue("A30TP-21992")
@Slf4j
public class CreateCurrentAutoRenewToOpenSubsQuarterlyWithDwnPay_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY);
    }
    ...
    public void enterMemberDetailsForFirstLocation() {
        ...
        setTestResultOnXRay("A30TP-31992");
        getPage(UnoAppMemberPage.class)
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterRenewToOpenSubscription() {
        ...
        setTestResultOnXRay("A30TP-31993");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Renew-to-open Subscription with credit card for past and frequency Quarterly for location first.")
    @TmsLink("A30TP-31806")
    public void createNonRenewSubscription() {
        log.info("Create Installment subscription with 1st location is align with one organization where subscription type is renew-to open frequency is quarterly and payment method is credit card where begin date is current and expiration date is future.");
        setTestResultOnXRay("A30TP-31806");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_renewal_auto_to_open(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY, SUB_RENEWAL_TYPE,
                        SUB_RENEWAL_DATE, SUB_RENEWAL_FREQUENCY));
    }

    @Test
    @Description("Create Renew-to-open Subscription with credit card with all required information for location one")
    @TmsLink("A30TP-31807")
    public void enterDetailsForSubscription() {
        log.info("Create Installment subscription with 1st location is align with one organization where subscription type is renew-to open frequency is quarterly and payment method is credit card when begin date is current and due date is future.");
        setTestResultOnXRay("A30TP-31807");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,SUB_CARD_HOLDER_NAME));
    }
    ...
    @Test
    @Description("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open begin date is current and frequency is quarterly and payment method is credit card and expiration date is future. ")
    @TmsLink("A30TP-31803")
    public void enterSubscriptionForSecondLcoation() {
        log.info("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open begin date is current and frequency is quarterly and payment method is credit card and expiration date is future.");
        setTestResultOnXRay("A30TP-31803");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,
    ...
    @Test
    @Description("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open frequency is quarterly and payment method is credit card when begin date is current and expiration date is future.")
    @TmsLink("A30TP-31994")
    public void enterCardDetails() {
        log.info("Create Installment subscription for 2nd location is align with one organization where subscription type is renew-to open frequency is quarterly and payment method is credit card when begin date is current and expiration date is future.");
        setTestResultOnXRay("A30TP-31994");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,
                        SUB_CARD_NUMBER, SUB_CARD_HOLDER_NAME, SUB_CARD_EXPIRY_YEAR, SUB_CARD_POSTAL_CODE))
                .click_on_submit_btn()
    ...
    public void verifySubscriptionTabForSecondLocation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOOPEN_QUARTERLY_CARD_DWN_PAY,SUB_TYPE));
    }
