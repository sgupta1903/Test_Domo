...
import static helper.DataProviderSection.CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD;

import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-12074")
@Slf4j
public class CreateCurrentAutoRenewToTermSubsWeekly_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD);
    }
    ...
    @Test
    @Description("Subscription creation has started for first location and enter the member details")
    @TmsLink("A30TP-12115")
    public void enterMemberDetailsForFirstLocation() {
        log.info("Subscription creation has started with member creation");
        setTestResultOnXRay("A30TP-12115");
        getPage(UnoAppMemberPage.class)
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterSubscriptionDetails() {
        log.info("Create Auto Renew to Term agreement Subscription Details.");
        setTestResultOnXRay("A30TP-12087");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Auto Renew to Term agreement Subscription with Card and frequency Weekly.")
    @TmsLink("A30TP-12063")
    public void createRenewToTermSubscription() {
        log.info("Create Auto Renew to Term agreement Subscription with Card and frequency Weekly");
        setTestResultOnXRay("A30TP-12063");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,
    ...
    public void enterDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,SUB_CARD_HOLDER_NAME));
    }
    ...
    @Test
    @Description("Enter subscription details for second location")
    @TmsLink("A30TP-12062")
    public void enterSubscriptionForSecondLocation() {
        log.info("Enter subscription details for second location");
        setTestResultOnXRay("A30TP-12062");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,
                        SUB_TYPE, SUB_DUE_DATE, SECOND_ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Auto Renew to Term agreement Subscription with Card and  frequency is Weekly for second location.")
    @TmsLink("A30TP-12116")
    public void createRenewToTermSubscriptionForSecondLocation() {
        log.info("Create Auto Renew to Term agreement Subscription with Card and  frequency is Weekly for second location.");
    ...
    @Test
    @Description("Enter Card details for second location")
    @TmsLink("A30TP-15941")
    ...
    public void verifySubscriptionTabForSecondLcoation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_WEEKLY_CARD,SUB_TYPE));
    }
