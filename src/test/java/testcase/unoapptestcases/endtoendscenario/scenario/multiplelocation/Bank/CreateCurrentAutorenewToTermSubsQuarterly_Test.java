...
import static helper.DataProviderSection.CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK;
import static util.UtilityGeneric.set_section_name;

@Issue("A30TP-12075")
@Slf4j
public class CreateCurrentAutorenewToTermSubsQuarterly_Test extends AbstractAutoUITest {
    
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK);
    }
    ...
    @Test
    @Description("Configure Merchant for EFT processor.")
    @TmsLink("A30TP-20723")
    public void configuringMerchantForEftProcessor() {
        log.info("Configure Merchant for EFT processor.");
    ...
    @Test
    @Description("Configure Merchant for EFT processor for second location")
    @TmsLink("A30TP-15917")
    public void creatingMerchantAccountForSecondLocation() {
        log.info("Configure Merchant for EFT processor for second location");
    ...
    public void selectAddMember() {
        ...
        setTestResultOnXRay("A30TP-21289");
    ...
    public void enterMemberDetailsForFirstLocation() {
        ...
        setTestResultOnXRay("A30TP-21290");
        getPage(UnoAppMemberPage.class)
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void enterSubscriptionDetails() {
        ...
        setTestResultOnXRay("A30TP-21312");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT));
    }

    @Test
    @Description("Create Auto-renew-to-term subscription with Bank_Account for past and frequency Annually.")
    @TmsLink("A30TP-12095")
    public void createRenewToTermSubscription() {
        log.info("Create Auto-renew-to-term subscription with Bank_Account for past and frequency Annually.");
        setTestResultOnXRay("A30TP-12095");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,
    ...
    @TmsLink("A30TP-21310")
    public void enterBankDetailsForSubscription() {
        log.info("Entering the details of bank account ");
        setTestResultOnXRay("A30TP-21310");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,
    ...
    public void verifySubscriptionCreatedForFirstLocation() {
        ...
        setTestResultOnXRay("A30TP-21314");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,SUB_ACCOUNT_HOLDER_NAME));
    ...
    public void selectAddMemberForSecondLocation() {
        ...
        setTestResultOnXRay("A30TP-21317");
        getPage(UnoAppMemberPage.class)
                .navigate_and_click_add_member_btn();
    }
    ...
    @TmsLink("A30TP-12086")
    public void enterSubscriptionDetailsForSecondLcoation() {
        log.info("Enter subscription information Bank_Account for past frequency Monthly for second location.");
        setTestResultOnXRay("A30TP-12086");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,
    ...
    public void enterBankingDetails() {
        ...
        setTestResultOnXRay("A30TP-21324");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,
                        SUB_ACCOUNT_HOLDER_NAME, SUB_BANK_ROUTING_NUMBER, SUB_BANK_ACCOUNT_NUMBER))
                .click_on_submit_btn();
    ...
    public void verifySubscriptionCreated() {
        ...
        setTestResultOnXRay("A30TP-21325");
        getPage(UnoAppSubscriptionPage.class)
                .verify_subscription_created();
        getPage(UnoAppMemberPage.class)
    ...
    public void verifySubscriptionTabForSecondLocation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_LOCATION_AUTORENEWTOTERM_QUARTERLY_BANK,SUB_TYPE));
    }
