...
import static helper.DataProviderSection.UPDATE_MEMBER_PROFILE_DETAILS;
...
@Issue("A30TP-32800")
@Slf4j
public class UpdateMemberProfileDetails_Test extends AbstractAutoUITest {

    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(UPDATE_MEMBER_PROFILE_DETAILS);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, UPDATE_MEMBER_PROFILE_DETAILS,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin date is past and expiration date is future where frequency is Weekly when renewal type is Non-renewal Agreement with down payment")
    @TmsLink("A30TP-21010")
    public void createNonRenewSubscription() {
        log.info("Create 'Installment' Subscription with Payment Method Type as 'Credit Card' when begin date is past and expiration date is future where frequency is Weekly when renewal type is Non-renewal Agreement with down payment");
        setTestResultOnXRay("A30TP-21010");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, UPDATE_MEMBER_PROFILE_DETAILS,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, UPDATE_MEMBER_PROFILE_DETAILS,
    ...
    public void enterPaymentsDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, UPDATE_MEMBER_PROFILE_DETAILS,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,UPDATE_MEMBER_PROFILE_DETAILS,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,UPDATE_MEMBER_PROFILE_DETAILS,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,UPDATE_MEMBER_PROFILE_DETAILS,SUB_TYPE));
    }
    ...
    @Test
    @Description("Clicking on edit button.")
    @TmsLink("A30TP-33729")
    public void clickEditButton() {
        log.info("Clicking on edit button.");
        setTestResultOnXRay("A30TP-33729");
        getPage(UnoAppMemberDetailPage.class)
                .click_on_edit_btn();
    }

    @Test
    @Description("Updating the member details")
    @TmsLink("A30TP-33642")
    public void updateMemberProfileDetails() {
        log.info("Verify that profile tab for subscription created for a member");
        setTestResultOnXRay("A30TP-33642");
        store_test_data("zipCode" , "36985-4712");
        getPage(UnoAppMemberDetailPage.class)
                .update_profile_details(retrieve_test_data("zipCode"));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,UPDATE_MEMBER_PROFILE_DETAILS,SUB_CARD_HOLDER_NAME));
    }
