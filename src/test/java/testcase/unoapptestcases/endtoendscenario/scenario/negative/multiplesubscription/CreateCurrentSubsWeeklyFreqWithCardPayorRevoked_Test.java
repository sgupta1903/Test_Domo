...
@Issue("A30TP-33839")
@Slf4j
public class CreateCurrentSubsWeeklyFreqWithCardPayorRevoked_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED);
    }
    ...
    public void createNonRenewInstallmentSubscription() {
        ...
        setTestResultOnXRay("A30TP-15932");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,
    ...
    public void addPaymentDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,SUB_TYPE));
    }
    ...
    public void createAnotherSubs() {
        ...
        setTestResultOnXRay("A30TP-15931");
        getPage(UnoAppMemberDetailPage.class)
                .enter_installment_another_subscription_details(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLESUBSCRIPTION_NONENEW_WEEKLY_CARD_PAYOR_REVOKED,SUB_CARD_HOLDER_NAME));
    }
