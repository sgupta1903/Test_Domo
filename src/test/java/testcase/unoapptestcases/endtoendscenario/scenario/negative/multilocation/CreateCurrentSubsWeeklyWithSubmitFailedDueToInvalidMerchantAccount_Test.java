...
import static helper.DataProviderSection.CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED;
...
@Issue("A30TP-33311")
@Slf4j
public class CreateCurrentSubsWeeklyWithSubmitFailedDueToInvalidMerchantAccount_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED);
    }
    ...
    @Test
    @Description("Adding Payment - Deduction  for first location")
    @TmsLink("A30TP-18792")
    public void addDeductionForFirstLocation() {
        log.info("Adding Payment - Deduction for first location");
    ...
    @Test
    @Description("Adding Payment - Reimbursement for first location")
    @TmsLink("A30TP-18804")
    public void addReimbursementForFirstLocation() {
        log.info("Adding Payment - Deduction for first location");
    ...
    public void enterSubscriptionScheduleDetails() {
        ...
        setTestResultOnXRay("A30TP-35310");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,SUB_ACCOUNT_HOLDER_NAME));
    ...
    @Description("Create Open-ended subscription with bank account where subscription with amount $40 where being date is current and frequency is Weekly without down payment.")
    @TmsLink("A30TP-35314")
    public void enterSubscriptionDetailsForSecondLocation() {
        log.info("Create Open-ended subscription with bank account where subscription with amount $40 where being date is current and frequency is Weekly without down payment.");
        setTestResultOnXRay("A30TP-35314");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,
    ...
    public void verifySubscriptionTabForSecondLcoation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_OPENENDED_WEEKLY_SUBMITTED_FAILED,SUB_TYPE));
    }
    ...
    @TmsLink("A30TP-42365")
    public void verifyPaymentStatusChanges() {
        log.info("Verifying Payment method is changed after new payment method is added");
    ...
    @Test
    @Description("Verifying Notes tab and it should be blank when no notes are added for a member of second location")
    @TmsLink("A30TP-15981")
