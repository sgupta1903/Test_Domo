...
import static helper.DataProviderSection.VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED;
...
@Issue("A30TP-32370")
@Slf4j
public class PaymentMethodStatusChangesToPayerRevoked extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED);
    }
    ...
    public void createSubsWithOneMember() {
        log.info("Creating member with all required fields");
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Enter Installment Subscription details  when begin date is past and expiration date is future")
    @TmsLink("A30TP-21010")
    public void createNonRenewSubscription() {
        log.info("Enter Installment Subscription details  when begin date is past and expiration date is future");
        setTestResultOnXRay("A30TP-21010");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
                        SUB_EXPIRY_DATE, SUB_DURATION));
    }

    @Test
    @Description("Entering CARD details for subscription creation")
    @TmsLink("A30TP-9718")
    public void enterPaymentsDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,VERIFY_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,SUB_CARD_HOLDER_NAME));
    }

    @Test
    @Description("Clicking on Payment-method list and stop payment.")
    @TmsLink("A30TP-33134")
    public void revokePaymentMethod() {
