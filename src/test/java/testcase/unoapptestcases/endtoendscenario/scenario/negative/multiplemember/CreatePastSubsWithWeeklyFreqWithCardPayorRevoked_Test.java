...
import static helper.DataProviderSection.CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED;
...
@Issue("A30TP-33846")
@Slf4j
public class CreatePastSubsWithWeeklyFreqWithCardPayorRevoked_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED);
    }
    ...
    public void configuringMerchantEftProcessor() {
        log.info("Configuring Merchant Vantiv processor configuration");
    ...
    @Test
    @Description("Enter schedule information for installment subscription with weekly frequency where payment-method as Credit card")
    @TmsLink("A30TP-34054")
    public void enterOpenEndedSubscriptionDetails() {
        log.info("Enter schedule information for installment subscription with weekly frequency where payment-method as Credit card");
        setTestResultOnXRay("A30TP-34054");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,SUB_CARD_HOLDER_NAME));
    }
    ...
    public void verifyPaymentMethodStatus() {
        ...
        setTestResultOnXRay("A30TP-34067");
        getPage(UnoAppMemberDetailPage.class)
    ...
    public void verifyNotesTab() {
        ...
        getPage(UnoAppNotesTabPage.class)
                .select_notes_tab()
                .verify_primary_member_notes(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_CARD_PAYOR_REVOKED,MEMBER_NOTES));
    }
