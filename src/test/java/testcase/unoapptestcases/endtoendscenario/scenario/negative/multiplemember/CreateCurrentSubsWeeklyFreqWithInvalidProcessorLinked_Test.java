...
import static helper.DataProviderSection.CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR;
...
@Issue("A30TP-33402")
@Slf4j
public class CreateCurrentSubsWeeklyFreqWithInvalidProcessorLinked_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR);
    }
    ...
    public void createNonRenewInstallmentSubscription() {
        ...
        setTestResultOnXRay("A30TP-38532");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR,
    ...
    public void addPaymentDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR, SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, CURRENT_MULTI_MEMBER_NONRENEW_WEEKLY_CARD_INVALID_PROCESSOR, SUB_CARD_HOLDER_NAME));
    }
    ...
    public void verifyPaymentStatusChanges() {
        ...
        setTestResultOnXRay("A30TP-38210");
        getPage(UnoAppMemberDetailPage.class)
