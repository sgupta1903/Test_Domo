...
import static helper.DataProviderSection.CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED;
...
@Issue("A30TP-33283")
@Slf4j
public class CreateCurrentSubsWeeklyFreqWithBankPayorRevoked_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED);
    }
    ...
    @Test
    @Description("Enter schedule information for installment subscription")
    @TmsLink("A30TP-8440")
    public void enterSubscriptionScheduleDetails() {
        log.info("Enter schedule information for installment subscription");
        setTestResultOnXRay("A30TP-8440");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,
                        SUB_EXPIRY_DATE, SUB_DURATION));
    }

    @Test
    @Description("Enter Subscription details and bank details for subscription creation for first location")
    @TmsLink("A30TP-34795")
    public void enterCardDetailsForSubscription() {
        log.info("Enter Subscription details and bank details for subscription creation for first location");
        setTestResultOnXRay("A30TP-34795");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,SUB_ACCOUNT_HOLDER_NAME));
    ...
    @Test
    @Description("Enter subscription information Bank_Account for current frequency Monthly for second location.")
    @TmsLink("A30TP-34796")
    public void enterSubscriptionForSecondLcoation() {
        log.info("Enter subscription information Bank_Account for current frequency Monthly for second location.");
        setTestResultOnXRay("A30TP-34796");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,
    ...
    public void verifySubscriptionTabForSecondLocation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLELOCATION_NONRENEW_WEEKLY_BANK_PAYOR_REVOKED,SUB_TYPE));
    }
