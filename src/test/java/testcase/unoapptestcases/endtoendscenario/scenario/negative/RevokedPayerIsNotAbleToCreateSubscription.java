package testcase.unoapptestcases.endtoendscenario.scenario.negative;
...
import static helper.DataProviderSection.CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED;
...
@Issue("A30TP-33231")
@Slf4j
public class RevokedPayerIsNotAbleToCreateSubscription extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED);
    }
    ...
    @Test
    @Description("Configure Merchant for the VANTIV processor")
    @TmsLink("A30TP-20722")
    public void configureMarchantForProcessor() {
        log.info("Configure Merchant for the VANTIV processor");
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Enter 'Installment' Subscription when begin date is past and expiration date is future where frequency is Weekly when renewal type is Non-renewal Agreement with down payment")
    @TmsLink("A30TP-21010")
    public void createNonRenewSubscription() {
        log.info("Create 'Installment' Subscription when begin date is past and expiration date is future where frequency is Weekly when renewal type is Non-renewal Agreement with down payment");
        setTestResultOnXRay("A30TP-21010");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
    ...
    @TmsLink("A30TP-9718")
    public void enterPaymentsDetailsForSubscription() {
        log.info("Entering the details of credit account ");
        setTestResultOnXRay("A30TP-9718");
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CREATE_SUBSCRIPTION_AFTER_PAYMENT_METHOD_STATUS_CHANGES_TO_PAYER_REVOKED,SUB_CARD_HOLDER_NAME));
    }

    @Test
    @Description("Clicking on Payment-method list and then click on stop payment button")
    @TmsLink("A30TP-33134")
    public void clickOnPaymentMethod() {
        log.info("Clicking on Payment-method list and then click on stop payment button");
    ...
    public void verifyPaymentMethodStatus() {
        ...
        setTestResultOnXRay("A30TP-33135");
        getPage(UnoAppMemberDetailPage.class)
    ...
    public void createAnotherSubsAferPaymentMethodIsRevoked() {
        ...
        setTestResultOnXRay("A30TP-33239");
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .add_subscription();
    }
