...
import static helper.DataProviderSection.CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX;
...
@Issue("A30TP-33825")
@Slf4j
public class RevokedPayerIsNotAbleToCreateAnotherSubscription_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX);
    }
    ...
    @Test
    @Description("Configure Merchant for the AMEX processor")
    @TmsLink("A30TP-35003")
    public void configureMerchantForAmexProcessor() {
        log.info("Configure Merchant for the AMEX processor");
        setTestResultOnXRay("A30TP-35003");
        getPage(MerchantAccountPage.class)
                .configure_merchant_amex();
    }
    ...
    @Test
    @Description("Create installment Subscription with two members when begin date and expiration date is current and frequency is Weekly with Credit Card with amount $40 ")
    @TmsLink("A30TP-35046")
    public void createNonRenewSubscription() {
        log.info("Create installment Subscription with two members when begin date and expiration date is current and frequency is Weekly with Credit Card with amount $40 ");
        setTestResultOnXRay("A30TP-35046");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,
    ...
    public void enterPaymentsDetailsForSubscription() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,SUB_CARD_HOLDER_NAME));
    }
    ...
    public void verifyNotesTab() {
        ...
        getPage(UnoAppNotesTabPage.class)
                .select_notes_tab()
                .verify_primary_member_notes(getTestData(SUBSCRIPTION_INI,CURRENT_TRYING_TO_ADD_SUBS_AFTER_PAYMENT_METHOD_PAYER_REVOKED_AMEX,MEMBER_NOTES));
    }
