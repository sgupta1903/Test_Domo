...
@Issue("A30TP-33810")
@Slf4j
public class CreatePastSubsMonthlyFreqWithCard_InvalidProcessorLinked_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay(" A30TP-14514");
        set_section_name(PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR);
    }
    ...
    public void createSubsWithOneMember() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR,
                        SUB_DOWNPAYMENT));
    }
    ...
    public void createNonRenewInstallmentSubscription() {
        ...
        setTestResultOnXRay("A30TP-38108");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR, SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR, ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR, SUB_TYPE));
    }
    ...
    public void createAnotherSubs() {
        ...
        setTestResultOnXRay("A30TP-38111");
        getPage(UnoAppMemberDetailPage.class)
                .enter_installment_another_subscription_details(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR,
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLESUBSCRIPTION_NONRENEW_MONTHLY_CARD_INVALID_PROCESSOR, SUB_CARD_HOLDER_NAME));
    }
