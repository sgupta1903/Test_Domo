...
import static helper.DataProviderSection.PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED;
...
@Issue("A30TP-33849")
@Slf4j
public class CreatePastSubsWeeklyWithPaymentMethodRevoked_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED);
    }
    ...
    @Test
    @Description("Create multiple location with one organization when for first location will be nominal subscription")
    @TmsLink("A30TP-34046")
    public void enterSubscriptionScheduleDetails() {
        log.info("Create multiple location with one organization when for first location will be nominal subscription");
        setTestResultOnXRay("A30TP-34046");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_payment_information_bank_account(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .click_payments_tab()
                .verify_wallet_payment_method_bank(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,PAYMENT_METHOD_BANK))
                .verify_wallet_bank_account_holder_name(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,SUB_ACCOUNT_HOLDER_NAME));
    ...
    public void enterSubscriptionDetailsForSecondLocation() {
        ...
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information_for_second_location(getTestData(SUBSCRIPTION_INI, PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,
    ...
    public void verifySubscriptionTabForSecondLocation() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                .select_subscription_tab()
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity_second_location_item(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,SECOND_ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,PAST_MULTIPLE_LOCATION_OPEN_ENDED_WEEKLY_BANK_PAYOR_REVOKED,SUB_TYPE));
    }
    ...
    public void verifyPaymentMethodStatus() {
        ...
        setTestResultOnXRay("A30TP-34049");
        getPage(UnoAppMemberDetailPage.class)
