...
@Issue("A30TP-33350")
@Slf4j
public class CreateCurrentSubsWithPaymentMechodChangesToTransferred_Test extends AbstractAutoUITest {
    @BeforeClass
    public void setSectionData() {
        log.info("Setting data for the test execution");
        setTestResultOnXRay("A30TP-14514");
        set_section_name(CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED);
    }
    ...
    public void enterDetailsForSubscription() {
        ...
        setTestResultOnXRay("A30TP-18423");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_downpayment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,
                        SUB_DOWNPAYMENT));
    }

    @Test
    @Description("Create installment Subscription for one member when begin date and expiration date is current and frequency is Weekly with Credit Card.")
    @TmsLink("A30TP-38302")
    public void enterScheduleInformation() {
        log.info("Create installment Subscription for one member when begin date and expiration date is current and frequency is Weekly with Credit Card.");
        setTestResultOnXRay("A30TP-38302");
        getPage(UnoAppSubscriptionPage.class)
                .enter_subscription_schedule_information(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,
                        SUB_TYPE, SUB_DUE_DATE, ITEM_NAME, SUB_BEGIN_DATE, SUB_PAY_FREQUENCY, SUB_PAY_AMOUNT))
                .enter_subscription_schedule_information_installment(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,
                        SUB_EXPIRY_DATE, SUB_DURATION))
                .enter_payment_information_credit_card(getTestData(SUBSCRIPTION_INI, CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,
                        SUB_CARD_NUMBER, SUB_CARD_HOLDER_NAME, SUB_CARD_EXPIRY_YEAR, SUB_CARD_POSTAL_CODE))
                .click_on_submit_btn();
    }

    @Test
    @Description("Verify the subscription created")
    @TmsLink("A30TP-18425")
    public void verifySubscriptionCreated() {
        log.info("Verify the subscription created");
        setTestResultOnXRay("A30TP-18425");
        getPage(UnoAppSubscriptionPage.class)
    ...
    public void verifySubscriptionTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_subscription_frequency(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,SUB_PAY_FREQUENCY))
                .verify_subscription_amenity(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,ITEM_NAME))
                .verify_subscription_type(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,SUB_TYPE));
    }
    ...
    public void verifyWalletTab() {
        ...
        getPage(UnoAppMemberDetailPage.class)
                ...
                .verify_wallet_card_account_holder_name(getTestData(SUBSCRIPTION_INI,CURRENT_MULTIPLE_MEMBER_INSTALLMENT_WEEKLY_PAYMENT_METHOD_CHANGES_TO_TRANSFERRED,SUB_CARD_HOLDER_NAME));
    }
    ...
    public void createAnotherPaymentMethod() {
        ...
        setTestResultOnXRay("A30TP-38307");
        getPage(UnoAppMemberDetailPage.class)
